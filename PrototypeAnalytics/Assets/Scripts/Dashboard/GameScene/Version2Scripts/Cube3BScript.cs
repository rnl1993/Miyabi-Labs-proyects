...
public class Cube3BScript : MonoBehaviour {
    ...
    {
        if (other.gameObject.GetComponent<GoalPoint_3B_Script>() != null)
        {
        ...
        if (other.gameObject.GetComponent<GoalPoint_1B_Script>() != null || other.gameObject.GetComponent<GoalPoint_2B_Script>() != null || other.gameObject.GetComponent<GoalPoint_4B_Script>() != null)
        {
