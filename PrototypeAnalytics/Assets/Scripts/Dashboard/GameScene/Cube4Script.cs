...
public class Cube4Script : MonoBehaviour {
    ...
    {
        if (other.gameObject.GetComponent<GoalPoint_4_Script>() != null)
        {
        ...
        if (other.gameObject.GetComponent<GoalPoint_1_Script>() != null || other.gameObject.GetComponent<GoalPoint_3_Script>() != null || other.gameObject.GetComponent<GoalPoint_3_Script>() != null)
        {
